...
// PLAY VIDEO FROM TRACK RECORD SECTION
  ...
  var player = new Vimeo.Player(document.getElementById('video-track-record-2'));
  document.getElementById('play-btn-track-2').addEventListener('click', function() {
    player.play();
  });
  var player = new Vimeo.Player(document.getElementById('video-track-record-3'));
  document.getElementById('play-btn-track-3').addEventListener('click', function() {
    player.play();
  });
  var player = new Vimeo.Player(document.getElementById('video-track-record-4'));
